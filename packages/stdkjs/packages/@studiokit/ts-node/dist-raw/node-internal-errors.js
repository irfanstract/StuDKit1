...
// /* ALTERED copy of https://raw.githubusercontent.com/nodejs/node/refs/tags/v22.11.0/lib/internal/errors.js */
...
//  * @template {(this: ThisT, ...args: Args) => R } T
//  * @param {T} fn
//  * @template ThisT thisT
//  * @template {unknown[]} Args args
//  * @template R return-type
//  * @returns {Extract<T, (...x: any[] ) => any> & ((this: ThisT, ...args: Args) => R ) }
//  */
// function hideStackFrames(fn) {
//   /**
//    * 
//    * @type {(this: ThisT, ...args: Args) => R }
//    */
...
// /**
//  * Utility function for registering the error codes. Only used here.
//  * Exported *only* to allow for testing.
//  * 
//  * @param {string} sym short-string-code
//  * @param {string | ((this: Error, ...x: unknown[] ) => any )} val value
//  * @param {(ErrorConstructor | TypeErrorConstructor) | (typeof SystemError)} def def
//  * @param {(ErrorConstructor | typeof HideStackFramesError )[] } otherClasses 
//  * 
//  */
...
// // the process exits.
// /**
//  * These are supposed to be called only on fatal exceptions before the process exits.
//  * 
//  * @satisfies {{ [k in keyof Record<String, unknown>] ?: (x: Error) => unknown } }
//  */
