...
namespace SharedElement
{
  export type EGA<SpclConstructor> = (
    readonly [... ArgsWithOptions<[host: Element, init: SpclConstructor, ], { targetSelector : string | null ; }> ]
  ) ;
...
export function installCssFromUrl(...[src, { targetSelector = null, } = {}]: ArgsWithOptions<[srcUrl: Extract<URL["href"], {}>], { targetSelector ?: string | null ; } > )
{
...
export function createAndAddNewScriptTag(...[]: [ ] )
{
